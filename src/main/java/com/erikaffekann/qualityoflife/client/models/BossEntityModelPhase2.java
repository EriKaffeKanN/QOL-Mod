package com.erikaffekann.qualityoflife.client.models;
...
public class BossEntityModelPhase2 extends EntityModel<BossEntity> {
	...
	public BossEntityModelPhase2() {
		...
		whenyou.setRotationPoint(0.0F, 24.0F, -5.0F);
		

		w = new ModelRenderer(this);
		w.setRotationPoint(0.0F, 0.0F, -8.0F);
		whenyou.addChild(w);
		w.setTextureOffset(12, 13).addBox(-1.0F, -17.0F, -6.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		w.setTextureOffset(12, 13).addBox(-1.0F, -20.0F, -3.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		...
		w.setTextureOffset(12, 13).addBox(-1.0F, -21.0F, 2.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		w.setTextureOffset(12, 13).addBox(-1.0F, -19.0F, 2.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		w.setTextureOffset(12, 13).addBox(-1.0F, -21.0F, -7.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		...
		h.setRotationPoint(0.0F, -1.0F, -4.0F);
		whenyou.addChild(h);
		...
		e.setRotationPoint(0.0F, 0.0F, 0.0F);
		whenyou.addChild(e);
		...
		n.setRotationPoint(0.0F, 0.0F, 0.0F);
		whenyou.addChild(n);
		...
		y.setRotationPoint(0.0F, 0.0F, 1.0F);
		whenyou.addChild(y);
		...
		o.setRotationPoint(0.0F, 0.0F, 1.0F);
		whenyou.addChild(o);
		...
		u.setRotationPoint(0.0F, 0.0F, 0.0F);
		whenyou.addChild(u);
		...
		u.setTextureOffset(12, 13).addBox(-1.0F, -15.0F, 23.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
	}
