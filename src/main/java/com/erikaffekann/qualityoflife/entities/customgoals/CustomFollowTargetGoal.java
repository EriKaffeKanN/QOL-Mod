...
// Essentially MeleeAttackGoal without the attack
public class CustomFollowTargetGoal extends Goal{
    ...
    public CustomFollowTargetGoal(CreatureEntity creature, double speedIn, boolean useLongMemory) {
